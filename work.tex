...
can undergo rate based dissolution and barrier failure \cite{clayton_generic_2011}.

Releases from the \gls{EBS} enter near field and subsequently far field host 
rock regions in which diffusive and advective transport take place, attenuated 
by solubility limits as well as sorption and dispersion phenomena 
...
\hline
III   & Solubility Factor      & $[-]$       & $1\times10^{-9}$    &  $5\times10^{10}$ \\
\hline
IV    & Partition Factor       & $[-]$       & $1\times10^{-9}$    &  $5\times10^{10}$ \\
\hline
V     & $R_{WFDegradation}$           & $[yr^{-1}]$       & $10^{-9}$    &  $10^{-2}$ \\
      & Inventory              & [MTHM]         & $10^{-4}$    &  $10^1$ \\
\hline 
